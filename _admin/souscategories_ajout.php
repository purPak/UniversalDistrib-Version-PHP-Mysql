...
if($user_id&&$groupe_id==="1") :
    ...
    // Requête SQL
    $req_ajout="INSERT INTO souscategories VALUES(NULL,'$nom_bdd','1','$remarques_bdd');";
    // Ajout dans la BDD
    if ($ajouter==="Ajouter") {
...
<html lang="fr">
    <head>
        <meta charset="UTF-8">
        <title>Ajout d'une sous-categorie - BackOffice - Universal Distrib</title>
            ...
            <div class="row">
                <div class="col-sm-8">
                    ...
                    <div class="tab-pane active fade in" id="contact">
                        <form class="well form-horizontal" method="post" action="souscategories_ajout.php">
                            <fieldset>
