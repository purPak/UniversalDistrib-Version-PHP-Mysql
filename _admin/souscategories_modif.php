...
if($user_id&&$groupe_id==="1") :
    ...
    // Requête SQL
    $affichage=mysqli_query($connect,"SELECT * FROM souscategories WHERE souscategorie_id='$id_aff_bdd'");
    $req_modif="UPDATE souscategories SET nom='$nom_bdd',actif='$actif_bdd',remarques='$remarques_bdd' WHERE souscategorie_id='$modif_id_bdd';";
    $req_supp="DELETE FROM souscategories WHERE souscategorie_id='$supp_id_bdd' AND souscategorie_id<>1;";
    ...
    if ($modifier==="Modifier") {
        ...
        header ("location:souscategories_modif.php?id_aff=$id_aff");
    }
...
<html lang="fr">
    <head>
        <meta charset="UTF-8">
        <title>Modification d'une sous-catégorie - BackOffice - Universal Distrib</title>
            ...
            <section class="row">
                <div class="col-sm-8">
                    ...
                    <div class="tab-pane active fade in" id="contact">
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <blockquote class="alert-danger">Attention, en confirmant, vous effacerez définitivement la sous-catégorie <strong><?php echo $row["nom"]; ?></strong>.</blockquote>
                                        <p class="text-center">
                                            <a href="souscategories_modif.php?supp_id=<?php echo $id_aff; ?>&amp;supprimer=valider&amp;choixcategorie=oui" class="btn btn-danger">Oui, je supprime la catégorie</a>&nbsp;
                                            <a href="souscategories_modif.php?id_aff=<?php echo $id_aff; ?>" class="btn btn-primary">Non, je conserve cette catégorie</a>
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <form class="well form-horizontal" method="post" action="souscategories_modif.php?id_aff=<?php echo $id_aff; ?>">
